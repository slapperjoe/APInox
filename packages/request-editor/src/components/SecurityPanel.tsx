...
export const SecurityPanel: React.FC<SecurityPanelProps> = ({ security, onChange }) => {
    const currentType = security?.type || 'none';

    const updateField = <K extends keyof WSSecurityConfig>(field: K, value: WSSecurityConfig[K]) => {
        const current = security || { type: 'none' as WSSecurityType };
    ...
    const handleTypeChange = (type: WSSecurityType) => {
        if (type === 'none') {
            ...
            onChange({
                ...
                passwordType: security?.passwordType || 'PasswordDigest',
            ...
            <Section>
                ...
                <FormRow>
                    ...
                    >
                        ...
                        <option value="usernameToken">UsernameToken</option>
                        <option value="certificate">Certificate</option>
                    </Select>
                </FormRow>
            </Section>

            {currentType === 'usernameToken' && (
                <>
                    <Section>
                        <SectionHeader>
                            <Key size={16} />
                        ...
                        <FormRow>
                            ...
                            <Select
                                value={security?.passwordType || 'PasswordDigest'}
                                onChange={(e) => updateField('passwordType', e.target.value as 'PasswordText' | 'PasswordDigest')}
                            >
                                <option value="PasswordDigest">PasswordDigest (Recommended)</option>
                                <option value="PasswordText">PasswordText (Plain)</option>
                            </Select>
                        </FormRow>
