/**
 * codeGenerator.ts — canonical copy lives here; both webview and request-editor re-export from this file.
 *
 * Generates client code snippets (curl, Node.js, Python, C#) from a SOAP request.
 */
