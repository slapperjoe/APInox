...
export const darkTheme: Theme = {
    ...
    variables: {
        ...
        // Unified UI additions (UI consistency audit)
        '--apinox-accent': '#4f8cff',
        '--apinox-accent-foreground-dim': 'rgba(79, 140, 255, 0.08)',
        '--apinox-error-background': 'rgba(244, 135, 113, 0.15)',

        '--apinox-error-border': '#f4877180',        '--apinox-tooltip-background': '#333333',
        '--apinox-tooltip-foreground': '#ffffff',
        '--apinox-brand-gradient': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        '--apinox-titleBar-activeBackground': '#1e1e1e',
        '--apinox-titleBar-activeForeground': '#c5c5c5',
        '--apinox-titleBar-inactiveBackground': '#252526',
        '--apinox-titleBar-border': 'transparent',
...
export const lightTheme: Theme = {
    ...
    variables: {
        ...
        // Unified UI additions (UI consistency audit)
        '--apinox-editor-font-size': '14px',
        '--apinox-editorLineNumber-foreground': '#237893',
        '--apinox-editorLineNumber-activeForeground': '#220000',
        '--apinox-editorError-foreground': '#e51400',
        '--apinox-editorWarning-foreground': '#bf8803',
        '--apinox-editorInfo-foreground': '#007acc',
        '--apinox-editorWidget-background': '#f3f3f3',
        '--apinox-editorWidget-foreground': '#3b3b3b',
        '--apinox-editorWidget-border': '#c8c8c8',
        '--apinox-inputValidation-errorBackground': '#fde7e9',
        '--apinox-inputValidation-errorBorder': '#e51400',
        '--apinox-inputValidation-errorForeground': '#e51400',
        '--apinox-inputValidation-warningBackground': '#fbf3ce',
        '--apinox-inputValidation-warningBorder': '#bf8803',
        '--apinox-inputValidation-warningForeground': '#bf8803',
        '--apinox-inputValidation-infoBackground': '#dbf2ff',
        '--apinox-inputValidation-infoBorder': '#007acc',
        '--apinox-inputValidation-infoForeground': '#007acc',
        '--apinox-notifications-background': '#ffffff',
        '--apinox-notifications-border': '#c8c8c8',
        '--apinox-notificationsInfoIcon-foreground': '#006ab1',
        '--apinox-progressBar-background': '#007acc',
        '--apinox-statusBar-background': '#007acc',
        '--apinox-activityBar-border': '#2c2c2c',
        '--apinox-activityBar-activeBorder': '#007acc',
        '--apinox-charts-foreground': '#3b3b3b',
        '--apinox-charts-red': '#e51400',
        '--apinox-charts-yellow': '#bf8803',
        '--apinox-debugIcon-breakpointForeground': '#e51400',
        '--apinox-debugTokenExpression-name': '#c586c0',
        '--apinox-diffEditor-insertedTextBackground': '#c8e6c980',
        '--apinox-diffEditor-removedTextBackground': '#f3c7c780',
        '--apinox-symbolIcon-classForeground': '#c29ac9',
        '--apinox-symbolIcon-fieldForeground': '#4e94ce',
        '--apinox-symbolIcon-propertyForeground': '#4e94ce',
        '--apinox-symbolIcon-variableForeground': '#4e94ce',
        '--apinox-symbolIcon-stringForeground': '#a31515',
        '--apinox-accent': '#007acc',
        '--apinox-accent-foreground-dim': 'rgba(0, 122, 204, 0.08)',
        '--apinox-error-background': 'rgba(229, 20, 0, 0.12)',

        '--apinox-error-border': '#e5140080',        '--apinox-tooltip-background': '#ffffff',
        '--apinox-tooltip-foreground': '#3b3b3b',
        '--apinox-brand-gradient': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        '--apinox-titleBar-activeBackground': '#f3f3f3',
        '--apinox-titleBar-activeForeground': '#3b3b3b',
        '--apinox-titleBar-inactiveBackground': '#ececec',
        '--apinox-titleBar-border': 'transparent',
...
export const solarizedDarkTheme: Theme = {
    ...
    variables: {
        ...
        // Unified UI additions (UI consistency audit)
        '--apinox-editor-font-size': '14px',
        '--apinox-editorLineNumber-foreground': '#586e75',
        '--apinox-editorLineNumber-activeForeground': '#93a1a1',
        '--apinox-editorError-foreground': '#dc322f',
        '--apinox-editorWarning-foreground': '#b58900',
        '--apinox-editorInfo-foreground': '#268bd2',
        '--apinox-editorWidget-background': '#073642',
        '--apinox-editorWidget-foreground': '#93a1a1',
        '--apinox-editorWidget-border': '#586e75',
        '--apinox-inputValidation-errorBackground': '#3a1a18',
        '--apinox-inputValidation-errorBorder': '#dc322f',
        '--apinox-inputValidation-errorForeground': '#dc322f',
        '--apinox-inputValidation-warningBackground': '#3a2f0a',
        '--apinox-inputValidation-warningBorder': '#b58900',
        '--apinox-inputValidation-warningForeground': '#b58900',
        '--apinox-inputValidation-infoBackground': '#0a2f3a',
        '--apinox-inputValidation-infoBorder': '#268bd2',
        '--apinox-inputValidation-infoForeground': '#268bd2',
        '--apinox-notifications-background': '#073642',
        '--apinox-notifications-border': '#586e75',
        '--apinox-notificationsInfoIcon-foreground': '#268bd2',
        '--apinox-progressBar-background': '#268bd2',
        '--apinox-activityBar-border': '#073642',
        '--apinox-activityBar-activeBorder': '#268bd2',
        '--apinox-charts-foreground': '#839496',
        '--apinox-charts-red': '#dc322f',
        '--apinox-charts-yellow': '#b58900',
        '--apinox-debugIcon-breakpointForeground': '#dc322f',
        '--apinox-debugTokenExpression-name': '#6c71c4',
        '--apinox-diffEditor-insertedTextBackground': '#85990033',
        '--apinox-diffEditor-removedTextBackground': '#dc322f33',
        '--apinox-symbolIcon-classForeground': '#cb4b16',
        '--apinox-symbolIcon-fieldForeground': '#268bd2',
        '--apinox-symbolIcon-propertyForeground': '#268bd2',
        '--apinox-symbolIcon-variableForeground': '#268bd2',
        '--apinox-symbolIcon-stringForeground': '#2aa198',
        '--apinox-textLink-foreground': '#268bd2',
        '--apinox-textLink-activeForeground': '#2aa198',
        '--apinox-textCodeBlock-background': '#07364266',
        '--apinox-accent': '#268bd2',
        '--apinox-accent-foreground-dim': 'rgba(38, 139, 210, 0.1)',
        '--apinox-error-background': 'rgba(220, 50, 47, 0.15)',

        '--apinox-error-border': '#dc322f80',        '--apinox-tooltip-background': '#002b36',
        '--apinox-tooltip-foreground': '#eee8d5',
        '--apinox-brand-gradient': 'linear-gradient(135deg, #268bd2 0%, #2aa198 100%)',
        '--apinox-titleBar-activeBackground': '#073642',
        '--apinox-titleBar-activeForeground': '#93a1a1',
        '--apinox-titleBar-inactiveBackground': '#002b36',
        '--apinox-titleBar-border': 'rgba(88, 110, 117, 0.2)',
...
export const solarizedLightTheme: Theme = {
    ...
    variables: {
        ...
        '--apinox-editor-font-size': '14px',
        '--apinox-editorLineNumber-foreground': '#586e75',
        '--apinox-editorLineNumber-activeForeground': '#073642',
        '--apinox-editorError-foreground': '#dc322f',
        '--apinox-editorWarning-foreground': '#b58900',
        '--apinox-editorInfo-foreground': '#268bd2',
        '--apinox-editorWidget-background': '#eee8d5',
        '--apinox-editorWidget-foreground': '#586e75',
        '--apinox-editorWidget-border': '#93a1a1',
        '--apinox-inputValidation-errorBackground': '#f5e3e2',
        '--apinox-inputValidation-errorBorder': '#dc322f',
        '--apinox-inputValidation-errorForeground': '#dc322f',
        '--apinox-inputValidation-warningBackground': '#f7f0d0',
        '--apinox-inputValidation-warningBorder': '#b58900',
        '--apinox-inputValidation-warningForeground': '#7a6200',
        '--apinox-inputValidation-infoBackground': '#e0eff5',
        '--apinox-inputValidation-infoBorder': '#268bd2',
        '--apinox-inputValidation-infoForeground': '#268bd2',
        '--apinox-notifications-background': '#fdf6e3',
        '--apinox-notifications-border': '#93a1a1',
        '--apinox-notificationsInfoIcon-foreground': '#268bd2',
        '--apinox-progressBar-background': '#268bd2',
        '--apinox-activityBar-border': '#e8e2cd',
        '--apinox-activityBar-activeBorder': '#268bd2',
        '--apinox-charts-foreground': '#586e75',
        '--apinox-charts-red': '#dc322f',
        '--apinox-charts-yellow': '#b58900',
        '--apinox-debugIcon-breakpointForeground': '#dc322f',
        '--apinox-debugTokenExpression-name': '#6c71c4',
        '--apinox-diffEditor-insertedTextBackground': '#85990026',
        '--apinox-diffEditor-removedTextBackground': '#dc322f26',
        '--apinox-symbolIcon-classForeground': '#cb4b16',
        '--apinox-symbolIcon-fieldForeground': '#268bd2',
        '--apinox-symbolIcon-propertyForeground': '#268bd2',
        '--apinox-symbolIcon-variableForeground': '#268bd2',
        '--apinox-symbolIcon-stringForeground': '#af5f00',
        '--apinox-accent': '#268bd2',
        '--apinox-accent-foreground-dim': 'rgba(38, 139, 210, 0.1)',
        '--apinox-error-background': 'rgba(220, 50, 47, 0.12)',

        '--apinox-error-border': '#dc322f80',        '--apinox-tooltip-background': '#fdf6e3',
        '--apinox-tooltip-foreground': '#586e75',
        '--apinox-brand-gradient': 'linear-gradient(135deg, #268bd2 0%, #2aa198 100%)',
        '--apinox-titleBar-activeBackground': '#eee8d5',
        '--apinox-titleBar-activeForeground': '#586e75',
        '--apinox-titleBar-inactiveBackground': '#f5f0dc',
        '--apinox-titleBar-border': 'rgba(88, 110, 117, 0.15)',
...
export const zedDarkTheme: Theme = {
    ...
    variables: {
        ...
        // Unified UI additions (UI consistency audit)
        '--apinox-accent': '#82aaff',
        '--apinox-accent-foreground-dim': 'rgba(130, 170, 255, 0.08)',
        '--apinox-error-background': 'rgba(255, 117, 127, 0.15)',

        '--apinox-error-border': '#ff757f80',        '--apinox-tooltip-background': '#1e2030',
        '--apinox-tooltip-foreground': '#c8d3f5',
        '--apinox-brand-gradient': 'linear-gradient(135deg, #82aaff 0%, #c792ea 100%)',
...
export const dankShellLightTheme: Theme = {
    ...
    variables: {
        ...
        // Unified UI additions (UI consistency audit)
        '--apinox-accent': '#0097a7',
        '--apinox-accent-foreground-dim': 'rgba(0, 151, 167, 0.08)',
        '--apinox-error-background': 'rgba(179, 38, 30, 0.12)',

        '--apinox-error-border': '#b3261e80',        '--apinox-tooltip-background': 'rgba(245, 250, 252, 0.95)',
        '--apinox-tooltip-foreground': '#171d1e',
        '--apinox-brand-gradient': 'linear-gradient(135deg, #009eaf 0%, #007d0b 100%)',
