...
const PreviewContainer = styled.div`
  ...
  h1 { font-size: 1.8em; border-bottom: 1px solid var(--apinox-panel-border, #80808059); padding-bottom: 0.2em; }
  h2 { font-size: 1.4em; }
  h3 { font-size: 1.15em; }

  p { margin: 0.6em 0; }

  a { color: var(--apinox-textLink-foreground, #3794ff); }
  ...
  blockquote {
    border-left: 3px solid var(--apinox-activityBar-activeBorder, #007fd4);
    margin: 0.8em 0;
    padding: 0.2em 1em;
  ...
  hr { border: none; border-top: 1px solid var(--apinox-panel-border, #80808059); margin: 1.4em 0; }
