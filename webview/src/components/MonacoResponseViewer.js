...
const ViewerContainer = styled.div `
  ...
  overflow: hidden;
`;
export const MonacoResponseViewer = ({ value, language = 'xml', showLineNumbers = true, onSelectionChange, autoFoldElements }) => {
    ...
    return (_jsx(ViewerContainer, { style: { opacity: isReady ? 1 : 0, transition: 'opacity 0.1s' }, children: _jsx(Editor, { height: "100%", defaultLanguage: language, value: value, theme: "vs-dark", options: {
