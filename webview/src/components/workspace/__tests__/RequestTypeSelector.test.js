...
describe('RequestTypeSelector', () => {
    ...
    it('should render SOAP options correctly by default', () => {
        render(_jsx(RequestTypeSelector, { ...defaultProps, requestType: "soap" }));
    ...
    it('should render REST options correctly', () => {
        render(_jsx(RequestTypeSelector, { ...defaultProps, requestType: "rest" }));
    ...
    it('should render GraphQL options correctly', () => {
        render(_jsx(RequestTypeSelector, { ...defaultProps, requestType: "graphql" }));
