...
describe('Delete Pattern - PerformanceSuiteEditor', () => {
    ...
    it('should follow delete pattern for requests', () => {
        ...
        render(_jsx(PerformanceSuiteEditor, { ...defaultProps, onDeleteRequest: onDeleteRequest }));
    ...
    it('should follow delete pattern for schedules', () => {
        ...
        render(_jsx(PerformanceSuiteEditor, { ...defaultProps, schedules: schedules, onDeleteSchedule: onDeleteSchedule }));
