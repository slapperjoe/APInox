...
`;
export const MonacoSingleLineInput = forwardRef(({ value, onChange, readOnly = false, onEnter, onFocus }, ref) => {
    ...
    return (_jsxs(InputContainer, { children: [_jsx("style", { children: `
                ...
                ` }), _jsx(Editor, { height: "26px" // Explicit height to match container
                , defaultLanguage: "text", value: value, onChange: handleChange, theme: "vs-dark", onMount: handleEditorDidMount, options: {
