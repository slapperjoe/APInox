...
describe('ScriptEditor', () => {
    ...
    it('should display the script content from props', () => {
        render(_jsx(ScriptEditor, { step: mockStep, onUpdate: mockOnUpdate, onBack: mockOnBack }));
    ...
    it('should not overwrite local edits when step prop updates with same content', () => {
        const { rerender } = render(_jsx(ScriptEditor, { step: mockStep, onUpdate: mockOnUpdate, onBack: mockOnBack }));
        // Rerender with same step
        rerender(_jsx(ScriptEditor, { step: mockStep, onUpdate: mockOnUpdate, onBack: mockOnBack }));
    ...
    it('should update content when step prop changes with different scriptContent', () => {
        ...
        rerender(_jsx(ScriptEditor, { step: updatedStep, onUpdate: mockOnUpdate, onBack: mockOnBack }));
