...
export const useLayoutHandler = ({ config, setConfig, setActiveView, selectedRequest, selectedOperation, selectedInterface, projects, selectedProjectName, setSelectedProjectName, setSelectedInterface, setSelectedOperation, setSelectedRequest, selectedStep, selectedTestCase, setSelectedTestCase, selectedPerformanceSuiteId, setSelectedPerformanceSuiteId }) => {
    ...
    const handleSetActiveViewWrapper = useCallback((view) => {
        setActiveView(view);
